...
function Home({id}) {
    return (
      <div id={id} className="w-full max-w-[1200px] bg-secondary-background mx-auto flex items-center">
        <div className="grid justify-center grid-flow-row md:grid-flow-col md:grid-cols-2 px-5 my-12 mx-auto gap-8">
          {/* Image Section */}
