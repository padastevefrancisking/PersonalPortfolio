...
function Home({ id }) {
  return (
    <div
      id={id}
      className="w-full max-w-[1200px] bg-secondary-background flex items-center justify-center min-h-screen"
    >
      <div className="grid justify-center grid-flow-row md:grid-flow-col md:grid-cols-2 px-5 my-12 gap-8">
        ...
        <div className="flex justify-center lato-light align-middle items-center">
          <img
            src="/Steve.png"
            alt="Steve Francis King"
            className="rounded-full w-64 h-64 md:w-96 md:h-96 shadow-2xl"
          />
        </div>
        ...
        <div className="flex flex-col items-center justify-center md:justify-start pt-8 text-center px-4">
          ...
          <p className="text-lg md:text-lg leading-7 md:leading-8 px-6 py-4 lato-regular text-justify text-white">
            An aspiring Software Engineer, Game Developer, and Application Developer third year Computer Science
            student of Visayas State University who is passionate in his studies, capable of providing quality works,
            and able to compromise to achieve results.
          </p>
